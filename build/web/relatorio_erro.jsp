...
<%
    ...
    try {
        ...
        PreparedStatement psPedido = con.prepareStatement(
            "SELECT p.data_pedido, p.data_atende, c.nome_do_cliente " +
...
<p><strong>Data do Pedido:</strong> <%= (dataPedido != null ? dataPedido.toString() : "N/A") %></p>
<p><strong>Data de Atendimento:</strong> <%= (dataAtende != null ? dataAtende.toString() : "N/A") %></p>
<%
        }
