...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <form action="salvar_pedido.jsp" method="post">
                <% if (isEdit) { %>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="mes_atual" class="form-control" 
                           value="<%= isEdit ? pedidoData.get("mes_atual") : "" %>">
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="subtotal[]" class="form-control subtotal" 
                                                   value="<%= String.format("%.2f", (int)item.get("quantidade") * (double)item.get("preco_unitario")) %>" readonly>
                                        </td>
                                        <td>
                ...
                <div class="action-buttons">
                    <input type="submit" value="<%= isEdit ? "Atualizar Pedido" : "Salvar Pedido" %>" class="btn btn-success">
                    <% if (isEdit) { %>
    ...
    <script>
        ...
        function adicionarItem() {
            ...
            // Adicionar evento ao novo input de quantidade
