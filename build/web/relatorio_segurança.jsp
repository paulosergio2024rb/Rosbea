...
<button class="print-btn" onclick="window.print()">🖨️ Imprimir Pedido</button>
...
<%
    ...
    try {
        ...
        PreparedStatement psPedido = con.prepareStatement("SELECT p.data_pedido, c.nome_do_cliente FROM pedido p JOIN cadastro_de_clientes c ON p.cliente_id = c.rg WHERE p.id = ?");
