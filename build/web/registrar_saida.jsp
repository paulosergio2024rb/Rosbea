...
<html>
<head>
    <title>Registrar Saída no Caixa</title>
...
<body>
    <div class="container">
        <div class="card">
            <h1><i class="fas fa-money-bill-wave"></i> Registrar Saída</h1>
            ...
            %>
                <div class="mensagem erro">
                    <i class="fas fa-exclamation-circle"></i> Não há caixa aberto. <a href="abrir_caixa.jsp">Abrir caixa</a> antes de registrar saídas.
                </div>
            <%
            } else {
            %>
            
            <form action="processar_saida.jsp" method="post">
                <input type="hidden" name="id_caixa" value="<%= idCaixaAberto %>">
                
                <div class="form-group input-icon">
                    <i class="fas fa-file-alt"></i>
                    <label for="descricao">Descrição</label>
                    <input type="text" id="descricao" name="descricao" placeholder="Ex: Compra de materiais" required>
                </div>
                ...
                <button type="submit">
                    <i class="fas fa-check-circle"></i> Registrar Saída
                </button>
            </form>
            <%
            }
            ...
            <div class="navigation-links">
                <a href="listar_caixa.jsp"><i class="fas fa-list-alt"></i> Ver Caixa</a>
