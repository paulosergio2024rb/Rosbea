        ...
        <div class="container">
            ...
            <%
                ...
                try {
                    ...
                    // Construir SQL base sem as colunas ml_produto e embalagem
                    String sql = "SELECT produto_id, nome_produto, total_vendido, total_comprado, saldo_estoque "
            ...
            <table>
                ...
                <tbody>
                    ...
                    %>
                    <tr>
                        <td colspan="5" class="no-results">Nenhum produto encontrado com os critérios de busca informados.</td>
                    </tr>
                    <%
                        }
                    %>
