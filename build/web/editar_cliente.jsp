...
<head>
    ...
    <!-- Adicionei apenas esta linha para o CSS do autocomplete -->
    ...
    <style>
        ...
        * {
        ...
        /* Adicionei apenas estes estilos para o autocomplete */
        .ui-autocomplete {
            max-height: 200px;
            overflow-y: auto;
            overflow-x: hidden;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <form method="get" class="search-form" id="searchForm">
                <input type="text" id="nome" name="nome" class="form-control" placeholder="Digite o nome do cliente" 
    ...
    <!-- Adicionei apenas estes scripts para o autocomplete -->
    ...
    $(function() {
        $("#nome").autocomplete({
            ...
            select: function(event, ui) {
                // Opcional: pode adicionar comportamento ao selecionar um item
                // $("#searchForm").submit(); // Descomente para submeter automaticamente
            }
        });
    });
    </script>
