        ...
        <%
            ...
            try {
                ...
                try {
                    ...
                    String sql = "INSERT INTO produto (codigo, nome, marca, preco, codigo_barbearia, " +
                    ...
                    st.setInt(1, codigo);
                    st.setString(2, nome);
                    st.setString(3, marca != null ? marca : ""); // Trata campo opcional
                    ...
                    if(linhasAfetadas > 0) {
                        ...
                        out.print("<p><a href='cadastro_produto.html'>Cadastrar outro produto</a></p>");
                    } else {
