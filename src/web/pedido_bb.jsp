                                    ...
                                    <select name="produto_id[]" class="form-control" onchange="atualizarPreco(event)" required>
                                        ...
                                        <%
                                            try {
                                                Class.forName("org.mariadb.jdbc.Driver");
                                                con = DriverManager.getConnection("jdbc:mariadb://localhost:3306/Rosbea", "root", "6421");
                                                PreparedStatement ps = con.prepareStatement("SELECT codigo, codigo_barbearia, preco FROM produto WHERE codigo_barbearia IS NOT NULL AND codigo_barbearia <> '' ORDER BY codigo_barbearia");
