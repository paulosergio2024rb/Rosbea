...
<head>
    ...
    <script>
        ...
        function abrirVencimentos() {
            ...
            const windowFeatures = 'width=600,height=500,resizable=yes,scrollbars=yes';
            
            if (pedidoId) {
                window.open('form_vencimentos.jsp?pedido_id=' + pedidoId, 'Vencimentos', windowFeatures);
            } else {
        ...
        <div class="card">
            ...
            <form action="salvar_pedido.jsp" method="post">
                ...
                <div class="btn-group">
                    ...
                    <button type="button" class="btn" onclick="abrirVencimentos()">Gerenciar Vencimentos</button>
                </div>
