...
<html lang="pt-BR">
    <head>
        ...
        <style>
            ...
            /* Estilo do botão Voltar ao Caixa */
            .btn-voltar-caixa {
        ...
        <div class="container-fluid py-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div class="d-none d-sm-inline-block">
                    ...
                    <a href="index.jsp" class="btn-voltar-caixa">
                        <i class="bi bi-arrow-left-circle"></i> Voltar ao Caixa
                    </a>
                </div>
            </div>
                                ...
                                <%
                                    ...
                                    try {
                                        ...
                                        if (nrPedidoBusca != null && !nrPedidoBusca.isEmpty()) {
                                            sql += " WHERE nr_pedido = ? ORDER BY nr_pedido ASC, data_pedidovcto ASC";
                                            stmt = conn.prepareStatement(sql);
                                            stmt.setString(1, nrPedidoBusca);
                                        } else {
                                            stmt = conn.prepareStatement(sql + " ORDER BY nr_pedido ASC, data_pedidovcto ASC LIMIT 100");
                                        }
                                        ...
                                        while (rs.next()) {
                                            ...
                                            Date dataVencimento = rs.getDate("vencto");
