...
<html>
    ...
    <body>
        ...
        <form method="get">
            ...
            <br>
            <a href="caixa.jsp">Voltar para a Busca</a>
        </form>
            ...
            <table>
                ...
                <tbody>
                    <%
                        ...
                        String sqlVencimentos = "SELECT id, data_pedidovcto, valor_parcela, pgto FROM vencimentos WHERE nr_pedido = ? ORDER BY data_pedidovcto";
                        ...
                        while (resultSetVencimentos.next()) {
                            ...
                            double valorPendente = valorTotal - valorPago;
        ...
        <%
                    ...
                    try {
                        if (resultSetDetalhesPedido != null) {
                            resultSetDetalhesPedido.close();
                        }
                        if (preparedStatementDetalhesPedido != null) {
                            preparedStatementDetalhesPedido.close();
                        }
                        if (resultSetVencimentos != null) {
                            resultSetVencimentos.close();
                        }
                        if (preparedStatementVencimentos != null) {
                            preparedStatementVencimentos.close();
                        }
                        if (connection != null) {
                            connection.close();
                        }
