...
<%
    try {
        ...
        Connection con = DriverManager.getConnection("jdbc:mariadb://localhost:3306/Rosbea", "root", "6421");
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="editar_cliente.jsp?rg=<%= rs.getString("rg") %>" class="btn btn-edit">
                                    <i class="fas fa-edit"></i> Editar
                                </a>
                                <a href="excluir_cliente.jsp?rg=<%= rs.getString("rg") %>" class="btn btn-delete">
