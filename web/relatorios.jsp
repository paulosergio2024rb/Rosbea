...
<div class="header-buttons">
    <a href="gerenciar_pedidos.html" class="button button-voltar">← Voltar</a>
</div>
...
%>
    <tr>
        ...
        <td><%= cliente %></td>
        <td><%= data %></td>
        <td><a class="button" href="relatorio.jsp?pedido_id=<%= id %>" target="_blank">Imprimir/Visualizar</a></td>
    </tr>
<%
        }
    } catch (Exception e) {
