    ...
    if (nrPedidoPagamento != null && !nrPedidoPagamento.isEmpty()) {
        ...
        try {
            ...
            if (updatesRealizadas > 0 || totalDescontos > 0) {
                ...
                // Cálculo do Resultado (Pagamentos - Descontos)
                double resultado = totalPagamentos - totalDescontos;
                out.println("<div class='resumo-item'><span>Resultado (Pagamentos - Descontos):</span><span class='resumo-valor'>R$ " + String.format("%.2f", resultado) + "</span></div>");
