...
<head>
    ...
    <style>
        ...
        select, input[type="date"] { padding: 8px; width: 200px; border: 1px solid #ddd; border-radius: 4px; }
        ...
        .summary-cards { display: flex; justify-content: space-between; margin: 20px 0; flex-wrap: wrap; }
        .card { background: white; border-radius: 5px; padding: 15px; width: 23%; box-shadow: 0 0 5px rgba(0,0,0,0.1); text-align: center; margin-bottom: 10px; }
        .card h3 { margin-top: 0; color: #555; font-size: 16px; }
        .card-value { font-size: 20px; font-weight: bold; color: #4CAF50; }
        @media (max-width: 768px) {
            .card { width: 48%; }
            .form-group { flex-direction: column; align-items: flex-start; }
            label { margin-bottom: 5px; width: 100%; }
